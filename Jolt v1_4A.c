...
// 
// V1.4A 9/29/14 DJ - Corrected problem with estimated time being calculated incorrectly if time was longer than 6 minutes
//                    Changed final behaviour to leave done message till key press
//                    Changed code to insure LED gets turned off.
//                    Changed order of messages displayed so estimated time is displayed first then "step back" message
//                    System start withLCD backlight on.
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
const unsigned char RSLMsg2[]  = " By RSL V1.4a   ";  
...
int Backlight_Timer = 2000;				// used to time out how long the backlight stays on, preloaded to start unit with backlight on
...
/*****************************************************************************
* Function Name: Display_Estimated_Time
* 
...
{
	unsigned char done, cancelled, button;
